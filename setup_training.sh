...
download_xlnet(){
  model=$1
  wget -P $data_dir https://storage.googleapis.com/xlnet/released_models/$model.zip
...
download_xlnet cased_L-12_H-768_A-12
download_xlnet cased_L-24_H-1024_A-16
...
python minimize_xlnet.py $spiece_model_file $data_dir $data_dir false
